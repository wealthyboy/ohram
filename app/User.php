...
class User extends Authenticatable
{
	...
	{
		return $this->hasMany('App\Address')->where('is_billing', false);
	}

	public function sameAsbilling()
	{
		return $this->hasOne('App\Address')->where('same_as_billing', true);
	}

	public function billing_address()
	{
		return $this->hasOne('App\Address')->where('is_billing', true);
	}
	...
	{
		return $this->hasOne('App\Address')->where('is_active', true);
	}
