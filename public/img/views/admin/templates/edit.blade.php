...
<body class="body">
   <div class="container-fluid">
      <div class="row">
         <div style="background-color: #333;" class="col-md-6">
            <div class="navigation mb-1 sec pointer">
            ...
            <div class="titles sec mb-1 pointer">
               <div style="display:none;" class="cancel-button"><a id="#" href="#">X</a></div>
            ...
            <div class="header sec mb-1 pointer">
              <div style="display:none;" class="cancel-button "><a id="#" href="#">X</a></div>
            ...
            <div class="sale1 sec mb-1 pointer">
               <div  style="display:none;" class="cancel-button"><a id="#" href="#">X</a></div>
            ...
            <div class="sale2 sec pointer mb-1">
               <div style="display:none;" class="cancel-button"><a id="#" href="#">X</a></div>
                                             ...
                                             <tr>
                                                <th width="280" align="left" class="container-wrap" valign="top" style="vertical-align: top; width:280px;">
                                                   <table width="280" align="left" class="container" border="0" cellpadding="0" cellspacing="0" style="width:280px;">
                                                      <tbody>
                                                         <tr>
                                                            <td align="center" class="container-image"><img src="https://www.ohram.org/images/products/i0t4pa1gO7qu9I4pEDjLs8t0yGxjZSXJHotSzjL1.jpeg" width="100%" height="auto" alt="" style="width: 100%; max-width: 280px; display: block; border: 0px;"></td>
                                                         </tr>
                                                         <tr>
                                                            <td height="30"></td>
                                                         </tr>
                                                ...
                                                <th width="280" align="right" class="container-wrap" valign="top" style="vertical-align: top;">
                                                   <table width="280" align="right" class="container" border="0" cellpadding="0" cellspacing="0" style="width:280px;">
                                                      <tbody>
                                                         <tr>
                                                            <td align="center" class="container-image"><img src="https://www.ohram.org/images/products/N1b5BhgY5Wh8YyQzJhT9OgznIoJjV4DukDVm0NmB.jpeg" width="100%" height="auto" alt="" style="width: 100%; max-width: 280px; display: block; border: 0px;"></td>
                                                         </tr>
                                                         <tr>
                                                            <td height="30"></td>
                                                         </tr>
            ...
            <div class="image50 sec mb-1 pointer">
               <div style="display:none;" class="cancel-button"><a id="#" href="#">X</a></div>
            ...
            <div class="team sec mb-1 pointer">
               <div style="display:none;" class="cancel-button"><a id="#" href="#">X</a></div>
            ...
            <div class="blog sec  mb-1 pointer">
               <div style="display:none;" class="cancel-button"><a id="#" href="#">X</a></div>
            ...
            <div class="text-blocks sec mb-1 pointer">
               <div style="display:none;" class="cancel-button"><a id="#" href="#">X</a></div>
            ...
            <div class="footer sec mb-1 pointer">
               <div style="display:none;" class="cancel-button"><a id="#" href="#">X</a></div>
         ...
         <div class="col-md-6 mt-5 ">
		    ...
		    <form id="form--template" action="{{ route('templates.update',['template'=>$template->id])  }}" method="post">
					@method('PATCH')
					@csrf
               ...
               <div class="form-group">
                  ...
                  <input type="text" name="name" class="form-control" value="{{ $template->name }}" id="template-name" aria-describedby="emailHelp" placeholder="Enter Name">
               </div>
         ...
         <form class="hide">
               <div class="form-row">
                  ...
                  <!-- <div class="form-group col-md-4">
                     ...
                     <input type="range"  id="btn-slider"  min="1" max="1000" id="slider" class="form-control"  placeholder="">
                  </div> -->
   ...
   <script type="text/javascript">
      $(document).ready(function(){
            ...
            $('.sec.pointer').on('click',function(e){
